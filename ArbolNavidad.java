...
public class ArbolNavidad {
	...
	public static void main(String[] args) {
		...
		for(int fila=0; fila<alturaArbol;fila++) {
			...
			/* salto de línea para que despúes de agregar los espacios y los asteriscos
				en el bucle principal, salte a la siguente linea para seguir
				dibujando los espacios y los asteriscos
			*/
		}
